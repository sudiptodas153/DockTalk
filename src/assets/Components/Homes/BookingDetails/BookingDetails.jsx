...
const BookingDetails = ({ list }) => {

    const { name, education, speciality, fee } = list;
    ...
    return (
        <div className='bg-white p-5 rounded-2xl mt-4 mx-3'>
            ...
            <div className='mt-4'>
            <button className='w-full btn rounded-2xl border-2 text-red-600 border-red-300'>Cancel Appointment</button>
            </div>
        </div>
    );
};
