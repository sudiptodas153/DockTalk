...
import { addBookingDoctor } from '../../../LocalStorage/LocalStorage';
        ...
        <div className='p-3 md:px-20'>
                ...
                <div>
                    ...
                    <div className='md:flex items-center gap-7'>
                        ...
                        <div className='flex gap-2 mt-3'>
                            {
                                availability.map(day => <div key={day} className='flex text-xs'>
            ...
            <div className='bg-white md:p-10 p-5 rounded-2xl mt-10'>
                ...
                <div className='mt-4'>
                    ...
                    <Link to={'/booking'}> <button onClick={()=>BookNow(id)}  className='btn rounded-3xl w-full mt-8 bg-blue-600 text-white font-semibold'>Book Appointment Now</button></Link>
                </div>
